...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.info.create') }}" class="btn btn-success m-1">
            ...
            <tbody>
                @foreach($infos as $info)
						<tr><td>{{ $info->id }}</td>
							...
							<td>{{ $info->dimanche }}</td>
						<td>
                    <a href="{{ route('admin.info.show', ['id' => $info->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.info.edit', ['id' => $info->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $info->id }}" class="btn btn-danger btn-sm deleteBtn">
