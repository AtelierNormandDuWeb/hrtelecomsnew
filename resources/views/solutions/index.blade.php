        ...
        <table  id="Solution" class="table">
            <thead>
                <tr>
                    <th scope="col">N#</th>
						...
						<th scope="col">Liste1</th>
						<th scope="col">Liste2</th>
						<th scope="col">Liste3</th>
						<th scope="col">Liste4</th>
						<th scope="col">Liste5</th>
            ...
            <tbody>
                @foreach($solutions as $solution)
						...
						<td>
                    <a href="{{ route('admin.solution.show', ['id' => $solution->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.solution.edit', ['id' => $solution->id]) }}" class="btn btn-success btn-sm">
