        ...
        <table  id="About" class="table">
            ...
            <tbody>
                @foreach($abouts as $about)
						...
						<td>
                    <a href="{{ route('admin.about.show', ['id' => $about->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.about.edit', ['id' => $about->id]) }}" class="btn btn-success btn-sm">
...
@section('scripts')
    ...
    <script>
        ...
        deleteButtons.forEach(deleteButton => {
            deleteButton.addEventListener('click', (event)=>{
                ...
                confirmDeleteBtn.addEventListener('click',async ()=>{
                    const csrfToken = document.head.querySelector('meta[name="csrf-token"]').content;
                    const response = await fetch('/admin/abouts/delete/'+id , {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#About th');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('About');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#About', JSON.stringify(selectedColumns));
        }
