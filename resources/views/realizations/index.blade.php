...
@section('content')
<div >
<h3> Détails de la réalisation</h3>
...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.realization.create') }}" class="btn btn-success m-1">

            Creer une réalisation
...
<div class="">
    ...
    <div class="table-responsive">
        <table  id="Realization" class="table">
            <thead>
                <tr>
                    <th scope="col">N#</th>
						<th scope="col">Nom</th>
						...
						<th scope="col">Détails du chantier</th>
						<th scope="col">Lieu du chantier</th>
        ...
        @foreach ([$realization->imageUrls[0]] as $url) 
        ...
        @endforeach
						...
						<td>
                    <a href="{{ route('admin.realization.show', ['id' => $realization->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.realization.edit', ['id' => $realization->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $realization->id }}" class="btn btn-danger btn-sm deleteBtn">
        ...
        <div class="d-flex justify-content-center">
            {{ $realizations->links('pagination::bootstrap-5') }}
        </div>
    </div>
</div>
</div>
    ...
    <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h3 class="modal-title fs-5" id="confirmModalLabel">Confirmer effacement</h3>
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/realizations/speed/' + id, {
                method: 'PUT',
        ...
        deleteButtons.forEach(deleteButton => {
            deleteButton.addEventListener('click', (event)=>{
                ...
                modalBody.innerHTML = `Etes vous sur de vouloir effacer cette réalisation ?</strong> `
                ...
                confirmDeleteBtn.addEventListener('click',async ()=>{
                    const csrfToken = document.head.querySelector('meta[name="csrf-token"]').content;
                    const response = await fetch('/admin/realizations/delete/'+id , {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Realization th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Realization');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Realization');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Realization', JSON.stringify(selectedColumns));
        }
        ...
        function sortTable(columnIndex) {
            const table = document.getElementById('Realization');
