        ...
        <div class="col-md-8">
            <form
                ...
                <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-success btn-lg" onclick="triggerFileInput('imageUrl')">
                ...
                <a href="{{ route('admin.heroslider.index') }}" class="btn btn-danger btn-lg mt-1">
                    Annuler
                    <i class="fa-solid fa-trash"></i>
                </a>
                <button class="btn btn-primary btn-lg mt-1"> {{ isset($heroslider) ? 'Modifier' : 'Creer' }}<i
