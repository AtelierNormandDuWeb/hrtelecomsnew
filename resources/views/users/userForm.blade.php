...
<div class="user-form-section">
    ...
    <form action="{{ isset($user) ? route('admin.user.update', ['user' => $user->id]) : route('admin.user.store') }}" method="POST" class="user-form">
        @csrf
        @if(isset($user))
            @method('PUT')
        @endif
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="{{ old('name', $user->name ?? '') }}" placeholder="Nom complet" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="email_verified_at" id="email_verified_at" value="{{ old('email_verified_at', $user->email_verified_at ?? '') }}" placeholder="YYYY-MM-DD HH:MM:SS">
            @error('email_verified_at') <p class="error-msg">{{ $message }}</p> @enderror
        </div>

        <div class="form-group">
            <label for="password">Mot de passe</label>
            <input type="password" name="password" id="password" placeholder="Mot de passe" {{ isset($user) ? '' : 'required' }}>
