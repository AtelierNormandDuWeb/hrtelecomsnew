...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.testimonial.create') }}" class="btn btn-success m-1">
        ...
        <table  id="Testimonial" class="table">
            ...
            <tbody>
                @foreach($testimonials as $testimonial)
						<tr><td>{{ $testimonial->id }}</td>
							<td>{{ $testimonial->compagny }}</td>
							<td>{{ $testimonial->name }}</td>
							<td>{{ $testimonial->text }}</td>
						<td>
                    <a href="{{ route('admin.testimonial.show', ['id' => $testimonial->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.testimonial.edit', ['id' => $testimonial->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $testimonial->id }}" class="btn btn-danger btn-sm deleteBtn">
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/testimonials/speed/' + id, {
                method: 'PUT',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Testimonial th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Testimonial');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Testimonial');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Testimonial', JSON.stringify(selectedColumns));
        }
        ...
        function sortTable(columnIndex) {
            const table = document.getElementById('Testimonial');
