            ...
            <tbody>
                @foreach($services as $service)
						<tr><td>{{ $service->id }}</td>
							...
							<td>{{ $service->text }}</td>
						<td>
                    <a href="{{ route('admin.service.show', ['id' => $service->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.service.edit', ['id' => $service->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $service->id }}" class="btn btn-danger btn-sm deleteBtn">
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/services/speed/' + id, {
                method: 'PUT',
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Service th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Service');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Service');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Service', JSON.stringify(selectedColumns));
        }
        ...
        function sortTable(columnIndex) {
            const table = document.getElementById('Service');
